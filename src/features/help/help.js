  ...
  template.innerHTML = `
    <dialog id="help-dialog" class="help-dialog" aria-labelledby="help-title">
      <div class="help-panel">
        ...
        <p class="help-shortcuts"><strong>Keyboard:</strong> Arrow keys move around steps. Enter adds a note. Delete or Backspace clears it. A focused clip moves with Arrow keys; hold Shift for four steps. When no control is focused, Space starts or resumes playback, or stops it and returns to step 1.</p>
