...
export function createV2HelpDialog({ root = document } = {}) {
  ...
  const panel = createElement("div", { className: "project-dialog-panel" }, [
    ...
    createElement("section", {}, [
      ...
      createElement("p", { textContent: "Choose Klinto Chip or Klinto Drums beside Add Instrument in Playlist or Mixer. When a Piano Roll auditions through Klinto Drums, C4 through B4 show Kick, Snare, Hat and Tom names; other rows keep their normal pitch names." }),
      ...
      createElement("p", { textContent: "Space toggles playback throughout Studio except while typing in a text field or using the Add Instrument chooser and button, where Space keeps its native control action. Escape closes the active device window and returns focus to its launcher." }),
