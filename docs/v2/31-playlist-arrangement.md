...
- Pattern-library default-expanded/collapse/dropdown/scalable selected-card/cog-action, marquee/group-drag, shortcut and right-click routing coverage, including clip > Instrument > Track priority, Track-menu positioning/dismissal, clicked-Track binding, Rename Instrument validation/undo/focus/live-label behaviour and clip-delete isolation, plus manual interaction review
